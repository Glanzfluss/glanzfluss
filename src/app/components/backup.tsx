    ...
    <section className="bg-gray-900 text-white py-24 px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      >
        ...
        <div className="space-y-6">
          {/* Frage 1 */}
          <details className="group bg-gray-900 border border-gray-800 rounded-xl p-6">
            <summary className="flex justify-between items-center cursor-pointer text-lg font-semibold">
              Wie läuft ein Termin bei mir vor Ort ab?
              <span className="transition-transform group-open:rotate-180 text-[#a3e635]">⌄</span>
            </summary>
            <p className="mt-3 text-gray-400">
              Wir kommen mit komplettem Equipment zu dir – Wasser, Strom oder Vorbereitung sind nicht erforderlich.
            </p>
          </details>
          ...
          <details className="group bg-gray-900 border border-gray-800 rounded-xl p-6">
            <summary className="flex justify-between items-center cursor-pointer text-lg font-semibold">
              Muss ich Wasser oder Strom bereitstellen?
              <span className="transition-transform group-open:rotate-180 text-[#a3e635]">⌄</span>
            </summary>
            <p className="mt-3 text-gray-400">
              Nein. Wir arbeiten autark und bringen alles mit, was wir benötigen.
            </p>
          </details>
