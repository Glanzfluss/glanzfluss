  ...
  return (
    <>
      ...
      <main className="bg-gray-900 text-white">
        ...
        <section className="relative flex flex-col items-center justify-center text-center pt-40 pb-28 px-6 bg-cover bg-center" style={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('pictures/GFWebImage4.WebP')`}} >
        ...
        <section
          ...
          style={{
            backgroundImage: `url('pictures/Windschutzscheibe_gefroren.WebP')`
          }}
        >
